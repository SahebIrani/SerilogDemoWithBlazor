		...
		public static async Task<IHostBuilder> RunWithSerilogAsync(this IHostBuilder hostBuilder)
		{
				...
				.CreateLogger())
			{
				...
				try
				{
					...
					//#endif
					//containerBuilder.RegisterType<IShoppingCartService>().As<IShoppingCartService>().SingleInstance();
					//containerBuilder.RegisterType<ShoppingCartService>().As<ShoppingCartService>().SingleInstance();
